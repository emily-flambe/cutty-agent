    ...
    t1 ||
      ...
      (function (t) {
        ...
        function i(N) {
          ...
          if (Q !== J) {
            N[0] = Q;
            e: for (var be = 0, x = N.length, F = x >>> 1; be < F; ) {
              var le = 2 * (be + 1) - 1,
                w = N[le],
                oe = le + 1,
                ge = N[oe];
        ...
        function o(N, J) {
          var Q = N.sortIndex - J.sortIndex;
          return Q !== 0 ? Q : N.id - J.id;
        }
        if (
        ...
        function ne() {
          if (((j = !1), _)) {
            ...
            try {
              e: {
                ((A = !1), C && ((C = !1), Y(K), (K = -1)), (v = !0));
                var Q = k;
                try {
                  t: {
                    for (
                      G(N), g = a(p);
                      g !== null && !(g.expirationTime > N && D());

                    ) {
                      var be = g.callback;
                      if (typeof be == "function") {
                        ((g.callback = null), (k = g.priorityLevel));
                        var x = be(g.expirationTime <= N);
                        if (((N = t.unstable_now()), typeof x == "function")) {
                          ((g.callback = x), G(N), (J = !0));
                          break t;
                        }
                        (g === a(p) && i(p), G(N));
                      } else i(p);
        ...
        ((t.unstable_IdlePriority = 5),
          ...
          (t.unstable_scheduleCallback = function (N, J, Q) {
...
function rx() {
  ...
  ((j.prototype.isReactComponent = {}),
    (j.prototype.setState = function (x, F) {
  ...
  ((V.constructor = Y), A(V, j.prototype), (V.isPureReactComponent = !0));
  var G = Array.isArray,
    q = { H: null, A: null, T: null, S: null, V: null },
    _ = Object.prototype.hasOwnProperty;
  function K(x, F, le, w, oe, ge) {
    return (
      (le = ge.ref),
      {
        $$typeof: t,
  ...
  function B(x, F) {
    return K(x.type, F, void 0, void 0, void 0, x.props);
  }
  function W(x) {
  ...
  function ue(x, F, le, w, oe) {
        ...
        case "object":
          switch (x.$$typeof) {
            ...
            case l:
              ...
              break;
            case y:
              return ((se = x._init), ue(se(x._payload), F, le, w, oe));
          }
      }
    if (se)
      return (
        ...
        G(oe)
          ? ((le = ""),
            se != null && (le = se.replace(ne, "$&/") + "/"),
            ue(oe, F, le, "", function (lt) {
              return lt;
            }))
          : oe != null &&
            (W(oe) &&
    ...
    if (G(x))
      for (var Te = 0; Te < x.length; Te++)
        ((w = x[Te]), (ge = Ee + te(w, Te)), (se += ue(w, F, le, ge, oe)));
    else if (((Te = k(x)), typeof Te == "function"))
      for (x = Te.call(x), Te = 0; !(w = x.next()).done; )
        ((w = w.value), (ge = Ee + te(w, Te++)), (se += ue(w, F, le, ge, oe)));
    else if (ge === "object") {
      if (typeof x.then == "function") return ue(ie(x), F, le, w, oe);
      throw (
        (F = String(x)),
        Error(
  ...
  return (
    ...
    (Re.StrictMode = i),
    (Re.Suspense = p),
    (Re.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = q),
    ...
    (Re.cloneElement = function (x, F, le) {
      if (x == null)
        throw Error(
      ...
      var w = A({}, x.props),
        ...
        ge = void 0;
      if (F != null)
        for (se in (F.ref !== void 0 && (ge = void 0),
        F.key !== void 0 && (oe = "" + F.key),
        F))
          !_.call(F, se) ||
            se === "key" ||
            se === "__self" ||
      ...
      if (se === 1) w.children = le;
      else if (1 < se) {
        for (var Ee = Array(se), Te = 0; Te < se; Te++)
          Ee[Te] = arguments[Te + 2];
        w.children = Ee;
      }
      return K(x.type, oe, void 0, void 0, ge, w);
    }),
    ...
    (Re.createElement = function (x, F, le) {
      var w,
        oe = {},
        ge = null;
      if (F != null)
        for (w in (F.key !== void 0 && (ge = "" + F.key), F))
          _.call(F, w) &&
            w !== "key" &&
            w !== "__self" &&
            w !== "__source" &&
      ...
      return K(x, ge, void 0, void 0, null, oe);
    }),
    ...
    (Re.memo = function (x, F) {
      return { $$typeof: m, type: x, compare: F === void 0 ? null : F };
    }),
    ...
    (Re.useActionState = function (x, F, le) {
      return q.H.useActionState(x, F, le);
    }),
    (Re.useCallback = function (x, F) {
      return q.H.useCallback(x, F);
    }),
    (Re.useContext = function (x) {
      return q.H.useContext(x);
    }),
    (Re.useDebugValue = function () {}),
    (Re.useDeferredValue = function (x, F) {
      return q.H.useDeferredValue(x, F);
    }),
    (Re.useEffect = function (x, F, le) {
      var w = q.H;
      if (typeof le == "function")
        throw Error(
          "useEffect CRUD overload is not enabled in this build of React."
        );
      return w.useEffect(x, F);
    }),
    (Re.useId = function () {
      return q.H.useId();
    }),
    (Re.useImperativeHandle = function (x, F, le) {
      return q.H.useImperativeHandle(x, F, le);
    }),
    (Re.useInsertionEffect = function (x, F) {
      return q.H.useInsertionEffect(x, F);
    }),
    (Re.useLayoutEffect = function (x, F) {
      return q.H.useLayoutEffect(x, F);
    }),
    (Re.useMemo = function (x, F) {
      return q.H.useMemo(x, F);
    }),
    (Re.useOptimistic = function (x, F) {
      return q.H.useOptimistic(x, F);
    }),
    (Re.useReducer = function (x, F, le) {
      return q.H.useReducer(x, F, le);
    }),
    ...
    (Re.useSyncExternalStore = function (x, F, le) {
      return q.H.useSyncExternalStore(x, F, le);
    }),
...
function ux() {
  ...
  function xt(e) {
    (ge.current === e && (le(oe), le(ge)),
      Ee.current === e && (le(Ee), (Ia._currentValue = Q)));
  }
...
`);
        for (
          ...
          u++;
        for (; f < L.length && !L[f].includes("DetermineComponentFrameRoot"); )
          f++;
        if (u === T.length || f === L.length)
          for (
            u = T.length - 1, f = L.length - 1;
            1 <= u && 0 <= f && T[u] !== L[f];
...
` +
  ...
  function Hi(e, n, r, u, f, d) {
    ...
    if (((u = e), typeof e == "function")) Uo(e) && (b = 1);
      ...
      e: switch (e) {
        case W:
          return ((e = $t(31, r, n, f)), (e.elementType = W), (e.lanes = d), e);
        case A:
        ...
        case q:
          return ((e = $t(13, r, n, f)), (e.elementType = q), (e.lanes = d), e);
        case _:
  ...
  function Vn(e) {
    ((e._currentValue = Yo.current), le(Yo));
  }
  function Go(e, n, r) {
    for (; e !== null; ) {
      var u = e.alternate;
  ...
  var V2 =
    ...
    Z2 = t.unstable_scheduleCallback,
    q2 = t.unstable_NormalPriority,
    gt = {
      $$typeof: V,
      Consumer: null,
      Provider: null,
  ...
  function Zi(e, n) {
    n === null ? w(Zl, Zl.current) : w(Zl, n.pool);
  }
  function m0() {
    var e = $o();
  ...
  function v0(e) {
    if (e === ya || e === qi) throw Error(i(483));
  }
  var al = !1;
  function Ko(e) {
    e.updateQueue = {
  ...
  function ka(e, n, r, u) {
    ...
    if (S !== null) {
      ...
      var T = S,
        L = T.next;
      ((T.next = null), b === null ? (d = L) : (b.next = L), (b = T));
      var X = e.alternate;
      X !== null &&
        ((X = X.updateQueue),
        (S = X.lastBaseUpdate),
        S !== b &&
          (S === null ? (X.firstBaseUpdate = L) : (S.next = L),
          (X.lastBaseUpdate = T)));
    }
    if (d !== null) {
      var P = f.baseState;
          ...
          e: {
            ...
            switch (xe.tag) {
              ...
              case 0:
                if (
                  ((we = xe.payload),
                  (H = typeof we == "function" ? we.call(Je, P, H) : we),
                  H == null)
                )
                  break e;
                P = y({}, P, H);
  ...
  function rs(e, n, r, u, f, d) {
    return (
      ...
      (n.updateQueue = null),
      (n.lanes = 0),
      (N.H = e === null || e.memoizedState === null ? id : ud),
      (ql = !1),
      (d = r(u, f)),
      (ql = !1),
      wr && (d = A0(n, r, u, f)),
  ...
  function wa(e) {
    ...
    return (
      ...
      (ht === null ? n.memoizedState : ht.next) === null &&
        ((n = n.alternate),
        (N.H = n === null || n.memoizedState === null ? id : ud)),
      e
    );
  }
  function Qi(e) {
  ...
  function ss(e) {
    ...
    if (
      ...
      for (r = n.data[n.index] = Array(e), u = 0; u < e; u++) r[u] = D;
    return (n.index++, r);
  }
  function Zn(e, n) {
    ...
    if (((d = e.baseState), f === null)) e.memoizedState = d;
      ...
      do {
        ...
        if (P !== L.lane ? (je & P) === P : (ol & P) === P) {
          ...
          ((P = L.action),
            ql && r(d, P),
            (d = L.hasEagerState ? L.eagerState : r(d, P)));
        } else
          ((H = {
            lane: P,
            revertLane: L.revertLane,
  ...
  function D0(e, n, r, u) {
    return ((e.baseState = r), cs(e, Pe, typeof u == "function" ? u : Zn));
  }
  ...
  var Ji = {
    ...
    id = {
      ...
      useCacheRefresh: function () {
        return (qt().memoizedState = P2.bind(null, Me));
      },
    },
    ud = {
      readContext: zt,
  ...
  function sd(e) {
    function n(z, M) {
      if (e) {
        var O = z.deletions;
        O === null ? ((z.deletions = [M]), (z.flags |= 16)) : O.push(M);
      }
    }
    function r(z, M) {
      if (!e) return null;
    ...
    function f(z, M) {
      return ((z = Hn(z, M)), (z.index = 0), (z.sibling = null), z);
    }
    function d(z, M, O) {
      return (
        (z.index = O),
        e
          ? ((O = z.alternate),
            O !== null
              ? ((O = O.index), O < M ? ((z.flags |= 67108866), M) : O)
              : ((z.flags |= 67108866), M))
          : ((z.flags |= 1048576), M)
      );
    }
    ...
    function S(z, M, O, $) {
      return M === null || M.tag !== 6
        ? ((M = Bo(O, z.mode, $)), (M.return = z), M)
        : ((M = f(M, O)), (M.return = z), M);
    }
    function T(z, M, O, $) {
      var ce = O.type;
      return ce === A
        ? X(z, M, O.props.children, $, O.key)
        : M !== null &&
            (M.elementType === ce ||
              (typeof ce == "object" &&
                ce !== null &&
                ce.$$typeof === B &&
                od(ce) === M.type))
          ? ((M = f(M, O.props)), Ta(M, O), (M.return = z), M)
          : ((M = Hi(O.type, O.key, O.props, null, z.mode, $)),
            Ta(M, O),
            (M.return = z),
            M);
    }
    function L(z, M, O, $) {
      return M === null ||
        ...
        ? ((M = Vo(O, z.mode, $)), (M.return = z), M)
        : ((M = f(M, O.children || [])), (M.return = z), M);
    }
    function X(z, M, O, $, ce) {
      return M === null || M.tag !== 7
        ? ((M = Nl(O, z.mode, $, ce)), (M.return = z), M)
        : ((M = f(M, O)), (M.return = z), M);
    }
    function P(z, M, O) {
      if (
        ...
        return ((M = Bo("" + M, z.mode, O)), (M.return = z), M);
      if (typeof M == "object" && M !== null) {
        switch (M.$$typeof) {
          case k:
            return (
              (O = Hi(M.type, M.key, M.props, null, z.mode, O)),
              Ta(O, M),
              (O.return = z),
              O
            );
          case v:
            return ((M = Vo(M, z.mode, O)), (M.return = z), M);
          case B:
            var $ = M._init;
            return ((M = $(M._payload)), P(z, M, O));
        }
        if (ue(M) || te(M))
          return ((M = Nl(M, z.mode, O, null)), (M.return = z), M);
        if (typeof M.then == "function") return P(z, Wi(M), O);
        if (M.$$typeof === V) return P(z, Vi(z, M), O);
        eu(z, M);
      }
      return null;
    }
    function H(z, M, O, $) {
      ...
      if (
        ...
        return ce !== null ? null : S(z, M, "" + O, $);
      if (typeof O == "object" && O !== null) {
        switch (O.$$typeof) {
          case k:
            return O.key === ce ? T(z, M, O, $) : null;
          case v:
            return O.key === ce ? L(z, M, O, $) : null;
          case B:
            return ((ce = O._init), (O = ce(O._payload)), H(z, M, O, $));
        }
        if (ue(O) || te(O)) return ce !== null ? null : X(z, M, O, $, null);
        if (typeof O.then == "function") return H(z, M, Wi(O), $);
        if (O.$$typeof === V) return H(z, M, Vi(z, O), $);
        eu(z, O);
      }
      return null;
    }
    function U(z, M, O, $, ce) {
      if (
        ...
        return ((z = z.get(O) || null), S(M, z, "" + $, ce));
      if (typeof $ == "object" && $ !== null) {
        switch ($.$$typeof) {
          case k:
            return (
              (z = z.get($.key === null ? O : $.key) || null),
              T(M, z, $, ce)
            );
          case v:
            return (
          ...
          case B:
            var De = $._init;
            return (($ = De($._payload)), U(z, M, O, $, ce));
        }
        if (ue($) || te($))
          return ((z = z.get(O) || null), X(M, z, $, ce, null));
        if (typeof $.then == "function") return U(z, M, O, Wi($), ce);
        if ($.$$typeof === V) return U(z, M, O, Vi(M, $), ce);
        eu(M, $);
      }
      return null;
    }
    function we(z, M, O, $) {
      for (
        ...
        (e && pe && Ze.alternate === null && n(z, pe),
          (M = d(Ze, M, ke)),
          De === null ? (ce = Ze) : (De.sibling = Ze),
          (De = Ze),
          (pe = Et));
      }
      if (ke === O.length) return (r(z, pe), qe && Hl(z, ke), ce);
      if (pe === null) {
        for (; ke < O.length; ke++)
          ((pe = P(z, O[ke], $)),
            pe !== null &&
              ...
              (De = pe)));
        return (qe && Hl(z, ke), ce);
      }
      for (pe = u(pe); ke < O.length; ke++)
        ((Et = U(pe, z, ke, O[ke], $)),
          Et !== null &&
            (e &&
              Et.alternate !== null &&
    ...
    function xe(z, M, O, $) {
      ...
      for (
        ...
        pe.index > ke ? ((Et = pe), (pe = null)) : (Et = pe.sibling);
        var El = H(z, pe, Ze.value, $);
        if (El === null) {
          pe === null && (pe = Et);
          break;
        }
        (e && pe && El.alternate === null && n(z, pe),
          (M = d(El, M, ke)),
          De === null ? (ce = El) : (De.sibling = El),
          (De = El),
          (pe = Et));
      }
      if (Ze.done) return (r(z, pe), qe && Hl(z, ke), ce);
      if (pe === null) {
        for (; !Ze.done; ke++, Ze = O.next())
          ((Ze = P(z, Ze.value, $)),
            Ze !== null &&
              ((M = d(Ze, M, ke)),
              De === null ? (ce = Ze) : (De.sibling = Ze),
      ...
      for (pe = u(pe); !Ze.done; ke++, Ze = O.next())
        ((Ze = U(pe, z, ke, Ze.value, $)),
          Ze !== null &&
            (e &&
              Ze.alternate !== null &&
              pe.delete(Ze.key === null ? ke : Ze.key),
            (M = d(Ze, M, ke)),
            De === null ? (ce = Ze) : (De.sibling = Ze),
            (De = Ze)));
      return (
    ...
    function Je(z, M, O, $) {
      if (
        ...
        switch (O.$$typeof) {
          case k:
            e: {
              for (var ce = O.key; M !== null; ) {
                if (M.key === ce) {
                  if (((ce = O.type), ce === A)) {
                    if (M.tag === 7) {
                      (r(z, M.sibling),
                        ($ = f(M, O.props.children)),
                        ($.return = z),
                        (z = $));
                      break e;
                    }
              ...
              O.type === A
                ? (($ = Nl(O.props.children, z.mode, $, O.key)),
                  ($.return = z),
                  (z = $))
                : (($ = Hi(O.type, O.key, O.props, null, z.mode, $)),
                  Ta($, O),
                  ($.return = z),
                  (z = $));
            }
          ...
          case v:
            e: {
              ...
              (($ = Vo(O, z.mode, $)), ($.return = z), (z = $));
            }
            return b(z);
          case B:
            return ((ce = O._init), (O = ce(O._payload)), Je(z, M, O, $));
        }
        if (ue(O)) return we(z, M, O, $);
        if (te(O)) {
          if (((ce = te(O)), typeof ce != "function")) throw Error(i(150));
          return ((O = ce.call(O)), xe(z, M, O, $));
        }
        if (typeof O.then == "function") return Je(z, M, Wi(O), $);
        if (O.$$typeof === V) return Je(z, M, Vi(z, O), $);
        eu(z, O);
      }
      return (typeof O == "string" && O !== "") ||
        ...
        ? ((O = "" + O),
          M !== null && M.tag === 6
            ? (r(z, M.sibling), ($ = f(M, O)), ($.return = z), (z = $))
            : (r(z, M), ($ = Bo(O, z.mode, $)), ($.return = z), (z = $)),
          b(z))
        : r(z, M);
    }
    return function (z, M, O, $) {
      try {
        _a = 0;
        var ce = Je(z, M, O, $);
        return ((_r = null), ce);
      } catch (pe) {
        if (pe === ya || pe === qi) throw pe;
        var De = $t(29, pe, null, z.mode);
        return ((De.lanes = $), (De.return = z), De);
      } finally {
      }
    };
  }
  ...
  function kd(e, n, r, u, f) {
    ...
    return (
      ...
      e !== null && !St
        ? (is(e, n, f), In(e, n, f))
        : (qe && S && Zo(n), (n.flags |= 1), _t(e, n, u, f), n.child)
    );
  }
    ...
    if (u.mode === "hidden") {
      ...
      if ((r & 536870912) !== 0)
        ((n.memoizedState = { baseLanes: 0, cachePool: null }),
          e !== null && Zi(n, d !== null ? d.cachePool : null),
          d !== null ? w0(n, d) : ts(),
          fd(n));
      else
        return (
      ...
      d !== null
        ? (Zi(n, d.cachePool), w0(n, d), cl(), (n.memoizedState = null))
        : (e !== null && Zi(n, null), ts(), cl());
  ...
  function Ss(e, n, r, u, f) {
    return (
      ...
      e !== null && !St
        ? (is(e, n, f), In(e, n, f))
        : (qe && u && Zo(n), (n.flags |= 1), _t(e, n, r, f), n.child)
    );
  }
  function _d(e, n, r, u, f, d) {
    return (
      ...
      e !== null && !St
        ? (is(e, n, d), In(e, n, d))
        : (qe && u && Zo(n), (n.flags |= 1), _t(e, n, r, d), n.child)
    );
  }
  function Td(e, n, r, u, f) {
    if ((Vl(n), n.stateNode === null)) {
      ...
      ((d.state = H),
        ...
        (L = n.memoizedState),
        S || H !== L || al
          ? (typeof P == "function" && (xs(n, r, P, u), (L = n.memoizedState)),
            (T = al || hd(n, r, T, u, H, L, b))
              ? (X ||
                  (typeof d.UNSAFE_componentWillMount != "function" &&
                    typeof d.componentWillMount != "function") ||
                  (typeof d.componentWillMount == "function" &&
      ...
      (e !== null && e.dependencies !== null && Bi(e.dependencies))
        ? (typeof S == "function" && (xs(n, r, S, u), (U = n.memoizedState)),
          (X =
            al ||
            hd(n, r, X, u, H, U, T) ||
            (e !== null && e.dependencies !== null && Bi(e.dependencies)))
            ? (L ||
                ...
                (typeof d.componentWillUpdate == "function" &&
                  d.componentWillUpdate(u, U, T),
                typeof d.UNSAFE_componentWillUpdate == "function" &&
                  d.UNSAFE_componentWillUpdate(u, U, T)),
              typeof d.componentDidUpdate == "function" && (n.flags |= 4),
              typeof d.getSnapshotBeforeUpdate == "function" &&
                (n.flags |= 1024))
            : (typeof d.componentDidUpdate != "function" ||
                (b === e.memoizedProps && H === e.memoizedState) ||
                (n.flags |= 4),
              typeof d.getSnapshotBeforeUpdate != "function" ||
                (b === e.memoizedProps && H === e.memoizedState) ||
                (n.flags |= 1024),
  ...
  function Rd(e, n, r) {
    ...
    if (
      ...
      if (d)
        ...
        if (((b = S.nextSibling && S.nextSibling.dataset), b)) var L = b.dgst;
        ((b = L),
          (u = Error(i(419))),
          (u.stack = ""),
          (u.digest = b),
    ...
    return f
      ? (cl(),
        ...
        L !== null ? (f = Hn(L, f)) : ((f = Nl(f, S, r, null)), (f.flags |= 2)),
        (f.return = n),
        (u.return = n),
        (u.sibling = f),
        (n.child = u),
        ...
        S === null
          ...
          : ((T = S.cachePool),
            T !== null
              ? ((L = gt._currentValue),
                (T = T.parent !== L ? { parent: L, pool: L } : T))
              : (T = m0()),
  ...
  function Dd(e, n, r) {
    ...
    else ((St = !1), qe && (n.flags & 1048576) !== 0 && o0(n, Ui, n.index));
  ...
  function tb(e, n, r) {
    ...
    switch ((qo(n), n.tag)) {
      ...
      case 13:
        ...
        if ((qn(n), (n.flags & 128) !== 0)) return ((n.lanes = r), n);
        if (
      ...
      case 19:
        if ((le(yt), (f = n.memoizedState), f === null)) return (it(n), null);
  ...
  function nb(e, n) {
    switch ((qo(n), n.tag)) {
      ...
      case 13:
        if (
          (qn(n), (e = n.memoizedState), e !== null && e.dehydrated !== null)
        ) {
  ...
  function hl(e, n) {
    if (n.subtreeFlags & 8772)
      for (n = n.child; n !== null; ) (Zd(e, n.alternate, n), (n = n.sibling));
  }
  function Yl(e) {
    for (e = e.child; e !== null; ) {
      var n = e;
      ...
      switch (b.tag) {
        ...
        case 22:
          ...
          (b.memoizedState !== null
            ...
            f && L & 2048 && Ls(b.alternate, b));
          break;
        case 24:
          (Cr(d, b, S, T, f), f && L & 2048 && Hs(b.alternate, b));
          break;
        default:
          Cr(d, b, S, T, f);
      }
  ...
  function Wd() {
    dn === 0 && (dn = (je & 536870912) === 0 || qe ? ch() : 536870912);
    var e = hn.current;
  ...
  function tp(e, n, r, u, f, d, b, S, T, L, X, P, H, U) {
    if (
      ((e.timeoutHandle = -1),
      (P = n.subtreeFlags),
      (P & 8192 || (P & 16785408) === 16785408) &&
        ((qa = { stylesheets: null, count: 0, unsuspend: qb }),
        Xd(n),
        (P = Yb()),
        P !== null))
    ) {
      ((e.cancelPendingCommit = P(
        op.bind(null, e, n, d, r, u, f, b, S, T, X, 1, H, U)
      )),
        bl(e, d, b, !L));
      return;
    }
        ...
        if (Xe !== 0 && Ne !== null) {
          ...
          switch (Xe) {
            ...
            case 6:
              hn.current === null && (n = !0);
              var L = Xe;
              if (((Xe = 0), (Jt = null), Lr(e, S, T, L), r && Mr)) {
                b = 0;
                break e;
              }
              break;
            default:
              ((L = Xe), (Xe = 0), (Jt = null), Lr(e, S, T, L));
          }
        }
        (ob(), (b = ot));
        break;
  ...
  function op(e, n, r, u, f, d, b, S, T) {
    ...
    if (n !== null) {
      ...
      if (
        ...
        ((u = N.T), (N.T = null), (f = J.p), (J.p = 2), (b = Qe), (Qe |= 4));
        try {
          lb(e, n, r);
        } finally {
          ((Qe = b), (J.p = f), (N.T = u));
        ...
        try {
          ...
          if (
            ...
            if (T !== null && zo(S)) {
              var L = T.start,
                X = T.end;
              if ((X === void 0 && (X = L), "selectionStart" in S))
                ((S.selectionStart = L),
                ...
                if (H.getSelection) {
                  ...
                  !U.extend && xe > Je && ((b = Je), (Je = xe), (xe = b));
                  var z = $h(S, xe),
                    M = $h(S, Je);
                  if (
                    z &&
                    ...
                    (O.setStart(z.node, z.offset),
                      U.removeAllRanges(),
                      xe > Je
                        ? (U.addRange(O), U.extend(M.node, M.offset))
                        : (O.setEnd(M.node, M.offset), U.addRange(O)));
                  }
                }
              }
            }
            for (P = [], U = S; (U = U.parentNode); )
              U.nodeType === 1 &&
                P.push({ element: U, left: U.scrollLeft, top: U.scrollTop });
            for (
  ...
  function fp() {
    if (Tt === 4 || Tt === 3) {
      ...
      if (
        ...
        try {
          ee.onCommitFiberRoot(I, n, void 0, (n.current.flags & 128) === 128);
        } catch {}
      if (u !== null) {
        ((n = N.T), (f = J.p), (J.p = 2), (N.T = null));
        try {
  ...
  function dp() {
    ...
    var r = so(Or),
      ...
      f = J.p;
    try {
      ((J.p = 32 > r ? 32 : r), (N.T = null), (r = qs), (qs = null));
      var d = yl,
        b = Or;
      ...
      e: {
        ...
        if (H !== void 0) {
          ...
          var xe = (n & 4) !== 0,
            ...
            z = xe ? (H !== null ? H + "Capture" : null) : H;
          xe = [];
          for (var M = L, O; M !== null; ) {
            var $ = M;
            if (
              ((O = $.stateNode),
              ($ = $.tag),
          ...
          0 < xe.length &&
            ((H = new U(H, we, null, r, X)),
            P.push({ event: H, listeners: xe }));
        }
      }
      if ((n & 7) === 0) {
        e: {
          ...
          if (
            ...
            if (
              ...
              (Je = U == null ? H : ta(U)),
              (O = we == null ? H : ta(we)),
              (H = new xe($, M + "leave", U, r, X)),
              (H.target = Je),
              (H.relatedTarget = O),
              ($ = null),
              lr(X) === L &&
                ((xe = new xe(z, M + "enter", we, r, X)),
                (xe.target = O),
                (xe.relatedTarget = Je),
                ($ = xe)),
              (Je = $),
              ...
              t: {
                for (xe = U, z = we, M = 0, O = xe; O; O = jr(O)) M++;
                for (O = 0, $ = z; $; $ = jr($)) O++;
                for (; 0 < M - O; ) ((xe = jr(xe)), M--);
                for (; 0 < O - M; ) ((z = jr(z)), O--);
                for (; M--; ) {
                  if (xe === z || (z !== null && xe === z.alternate)) break t;
                  ((xe = jr(xe)), (z = jr(z)));
                }
                xe = null;
              }
            else xe = null;
            (U !== null && Ep(P, H, U, xe, !1),
        ...
        switch (((De = L ? ta(L) : window), e)) {
          case "focusin":
            (Zh(De) || De.contentEditable === "true") &&
              ((dr = De), (Do = L), (ca = null));
            break;
          case "focusout":
            ca = Do = dr = null;
  ...
  function Ep(e, n, r, u, f) {
    for (var d = n._reactName, b = []; r !== null && r !== u; ) {
      ...
      ((S !== 5 && S !== 26 && S !== 27) ||
        ...
        ((T = L),
        f
          ? ((L = na(r, d)), L != null && b.unshift(Ua(r, L, T)))
          : f || ((L = na(r, d)), L != null && b.push(Ua(r, L, T)))),
        (r = r.return));
    }
...
`
    ...
    switch (n) {
          ...
          if (r.hasOwnProperty(U) && P != null)
            switch (U) {
              ...
              case "defaultValue":
                T = P;
              default:
                u.hasOwnProperty(U) || Ke(e, n, U, null, u, P);
            }
        }
        for (var H in u) {
          var U = u[H];
          if (((P = r[H]), u.hasOwnProperty(H) && (U != null || P != null)))
            switch (H) {
              case "type":
                d = U;
                break;
      ...
      case "option":
        for (var we in r)
          if (
            ((H = r[we]),
            r.hasOwnProperty(we) && H != null && !u.hasOwnProperty(we))
          )
            switch (we) {
              case "selected":
                e.selected = !1;
        ...
        for (T in u)
          if (
            ((H = u[T]),
            (U = r[T]),
            u.hasOwnProperty(T) && H !== U && (H != null || U != null))
          )
            switch (T) {
              case "selected":
                e.selected =
      ...
      case "menuitem":
        ...
        for (L in u)
          if (
            ((H = u[L]),
            (U = r[L]),
            u.hasOwnProperty(L) && H !== U && (H != null || U != null))
          )
            switch (L) {
              case "children":
              case "dangerouslySetInnerHTML":
    ...
    if (r && e) {
      ...
      if (
        ...
        switch (u) {
          ...
          case "worker":
          case "script":
            if (r.querySelector(Za(d))) return;
        }
    ...
    if (u && e) {
      ...
      if (!b) {
        ...
        if ((b = u.querySelector(Va(d)))) S.loading = 5;
          ...
          (kt(T),
            Ct(T, "link", e),
            (T._p = new Promise(function (L, X) {
              ((T.onload = L), (T.onerror = X));
            })),
  ...
  function qp(e, n, r, u, f, d, b, S, T, L, X, P) {
    return (
      (e = new Fb(e, n, r, b, S, T, L, P)),
      (n = 1),
      d === !0 && (n |= 24),
      (d = $t(3, null, null, n)),
      (e.current = d),
  ...
  return (
    ($a.createRoot = function (e, n) {
      ...
      return (
        ...
        (n = qp(e, 1, !1, null, null, r, u, f, d, b, S, null)),
        (e[nr] = n.current),
        ec(e),
        new bc(n)
      );
    ...
    ($a.hydrateRoot = function (e, n, r) {
      ...
      return (
        r != null &&
          ...
          r.formState !== void 0 && (L = r.formState)),
        (n = qp(e, 1, !0, n, r ?? null, u, f, d, b, S, T, L)),
        (n.context = Ip(null)),
        (r = n.current),
        (u = Wt()),
        (u = oo(u)),
...
function Mm(t, l, a = {}) {
  ...
  const k = h ?? "main",
    ...
    R = typeof y == "function" ? async () => j(await y()) : j(y);
  return {
    host: g,
    path: v,
    room: s,
...
Vm = Cx;
var Zm = "AI_TypeValidationError",
  qm = `vercel.ai.error.${Zm}`,
  Rx = Symbol.for(qm),
  Im,
...
Zx.map((t) => t.code);
function qx({ promptTokens: t, completionTokens: l }) {
...
async function hv({
  ...
  let G = 0;
  for (;;) {
    const { value: q } = await R.read();
    if (q && (V.push(q), (G += q.length), q[q.length - 1] !== cv)) continue;
    if (V.length === 0) break;
    const _ = fv(V, G);
    G = 0;
    const K = Y.decode(_, { stream: !0 })
      .split(
        `
`
      )
...
async function dv({
  ...
  let k, v, A;
  function C(_, K) {
    const B = g.parts.find(
      (W) => W.type === "tool-invocation" && W.toolInvocation.toolCallId === _
    );
    B != null
      ? (B.toolInvocation = K)
      : g.parts.push({ type: "tool-invocation", toolInvocation: K });
  }
  const j = [];
  ...
  function q() {
    ...
    const K = { ...structuredClone(g), revisionId: o() };
    l({ message: K, data: _, replaceLastMessage: m });
  }
  (await hv({
    stream: t,
    onTextPart(_) {
      ...
      (A == null
        ...
        v == null
          ? ((v = { type: "reasoning", reasoning: _, details: [A] }),
            g.parts.push(v))
          : (v.reasoning += _),
        (g.reasoning = ((K = g.reasoning) != null ? K : "") + _),
        q());
    },
    ...
    onFilePart(_) {
      (g.parts.push({ type: "file", mimeType: _.mimeType, data: _.data }), q());
    },
    onSourcePart(_) {
      (g.parts.push({ type: "source", source: _ }), q());
    },
    onToolCallStreamingStartPart(_) {
      ...
      (g.toolInvocations.push(K), C(_.toolCallId, K), q());
    },
    onToolCallDeltaPart(_) {
      const K = Y[_.toolCallId];
      K.text += _.argsTextDelta;
      const { value: B } = Yx(K.text),
        W = {
          state: "partial-call",
          step: K.step,
          toolCallId: _.toolCallId,
      ...
      ((g.toolInvocations[K.index] = W), C(_.toolCallId, W), q());
    },
    async onToolCallPart(_) {
      const K = { state: "call", step: y, ..._ };
      if (
        (Y[_.toolCallId] != null
          ? (g.toolInvocations[Y[_.toolCallId].index] = K)
          : (g.toolInvocations == null && (g.toolInvocations = []),
            g.toolInvocations.push(K)),
        C(_.toolCallId, K),
        q(),
        a)
      ) {
        const B = await a({ toolCall: _ });
        if (B != null) {
          const W = { state: "result", step: y, ..._, result: B };
          ((g.toolInvocations[g.toolInvocations.length - 1] = W),
            C(_.toolCallId, W),
            q());
        }
      }
    ...
    onToolResultPart(_) {
      const K = g.toolInvocations;
      if (K == null)
        throw new Error("tool_result must be preceded by a tool_call");
      const B = K.findIndex((D) => D.toolCallId === _.toolCallId);
      if (B === -1)
        throw new Error(
          "tool_result must be preceded by a tool_call with the same toolCallId"
        );
      const W = { ...K[B], state: "result", ..._ };
      ((K[B] = W), C(_.toolCallId, W), q());
    },
    onDataPart(_) {
      (j.push(..._), q());
    },
    onMessageAnnotationsPart(_) {
      (R == null ? (R = [..._]) : R.push(..._), q());
    },
    onFinishStepPart(_) {
      ((y += 1), (k = _.isContinued ? k : void 0), (v = void 0), (A = void 0));
    },
    onStartStepPart(_) {
      (m || (g.id = _.messageId), g.parts.push({ type: "step-start" }), q());
    },
    onFinishMessagePart(_) {
      ((G = _.finishReason), _.usage != null && (V = qx(_.usage)));
    },
    onErrorPart(_) {
      throw new Error(_);
    },
  }),
    i?.({ message: g, finishReason: G, usage: V }));
}
  ...
  const V = await (
    A === "resume"
      ...
      : k(t, {
          ...
          headers: { "Content-Type": "application/json", ...o },
          signal: (j = c?.()) == null ? void 0 : j.signal,
          credentials: i,
        })
  ).catch((G) => {
    throw (s(), G);
  ...
  switch (a) {
    ...
    case "data": {
      await dv({
        ...
        lastMessage: v,
        onToolCall: y,
        onFinish({ message: G, finishReason: q, usage: _ }) {
          m && G != null && m(G, { usage: _, finishReason: q });
        },
        generateId: g,
      });
      return;
...
function vv() {
  ...
  function h(g, k) {
    ...
    return (
      c(
        function () {
          ((C.value = v), (C.getSnapshot = k), p(C) && j({ inst: C }));
        },
        [g, v, k]
      ),
      o(
...
async function Km(...t) {
  ...
  async function g(k) {
    ...
    const [A, C] = Pm(l, v),
      ...
      G = () => {
        ...
        return (Rn(c.revalidate)
          ...
          : c.revalidate !== !1) && (delete Y[v], delete V[v], ae && ae[0])
          ? ae[0](Xm).then(() => A().data)
          : A().data;
      };
    if (t.length < 3) return G();
    let q = i,
      _;
    const K = df();
    R[v] = [K, 0];
    const B = !Be(p),
      ...
      ne = W._c,
      te = Be(ne) ? D : ne;
    if ((B && ((p = Rn(p) ? p(te, D) : p), C({ data: p, _c: te })), Rn(q)))
      try {
        q = q(te);
      } catch (ae) {
        _ = ae;
    ...
    if (q && $m(q))
      if (
        ...
        if (_) throw _;
        return q;
      } else _ && B && m(_) && ((s = !0), C({ data: te, _c: Ht }));
    if (s && !_)
      if (Rn(s)) {
        const ae = s(q, te);
        C({ data: ae, error: Ht, _c: Ht });
      } else C({ data: q, error: Ht, _c: Ht });
    if (
      ((R[v][1] = df()),
...
const w1 = (t, l) => {
  ...
  qv = Wm ? window.__SWR_DEVTOOLS_USE__ : [],
  Iv = () => {
...
const Oc =
  ...
  Pv = (t, l, a) => {
    const {
      ...
      J = E.useMemo(() => {
        const Se =
            !R || !l ? !1 : Be(h) ? (B().isPaused() || c ? !1 : p !== !1) : h,
          ve = (Ye) => {
            const ft = Cl(Ye);
            return (
              delete ft._k,
      ...
      x = v[R] && v[R].length > 0,
      F = Q.data,
      le = Be(F) ? (ue && $m(ue) ? Oc(ue) : ue) : F,
      w = Q.error,
      oe = E.useRef(le),
      ge = k ? (Be(F) ? (Be(oe.current) ? le : oe.current) : F) : le,
      se =
        x && !Be(w)
          ? !1
          : be && !Be(h)
      ...
      at = E.useCallback(
        async (Se) => {
          const ve = _.current;
          if (!R || !ve || G.current || B().isPaused()) return !1;
          let Oe,
            _e,
            Ie = !0;
          const At = Se || {},
            Fe = !C[R] || !At.dedupe,
            Ye = () =>
              k1 ? !G.current && R === q.current && V.current : R === q.current,
          ...
          try {
            if (
              ...
              return (Fe && Ye() && B().onDiscarded(R), !1);
            ft.error = Ht;
            const mt = A[R];
            if (!Be(mt) && (_e <= mt[0] || _e <= mt[1] || mt[1] === 0))
              return (el(), Fe && Ye() && B().onDiscarded(R), !1);
            const I = D().data;
            ((ft.data = o(I, Oe) ? I : Oe),
              Fe && Ye() && B().onSuccess(Oe, R, a));
          } catch (mt) {
            On();
            const I = B(),
              { shouldRetryOnError: ee } = I;
            I.isPaused() ||
              ((ft.error = mt),
              Fe &&
                Ye() &&
      ...
      xt = E.useCallback((...Se) => Km(i, q.current, ...Se), []);
    if (
      (Mc(() => {
        ((_.current = l), (K.current = a), Be(F) || (oe.current = F));
      }),
      Mc(() => {
        if (!R) return;
        ...
        const _e = $v(R, v, (Ie, At = {}) => {
          if (Ie == Fm) {
            ...
            B().revalidateOnFocus &&
              Fe > ve &&
              W() &&
              ((ve = Fe + B().focusThrottleInterval), Se());
          } else if (Ie == Qm) B().revalidateOnReconnect && W() && Se();
          else {
            if (Ie == Xm) return at();
      ...
      Mc(() => {
        let Se;
        function ve() {
          const _e = Rn(m) ? m(D().data) : m;
          _e && Se !== -1 && (Se = setTimeout(Oe, _e));
        }
        function Oe() {
          !D().error && (y || B().isVisible()) && (g || B().isOnline())
            ? at(Nc).then(ve)
            : ve();
        }
        return (
      ...
      ((_.current = l), (K.current = a), (G.current = !1));
      const Se = j[R];
      if (!Be(Se)) {
        const ve = xt(Se);
        Oc(ve);
...
function t6({
  ...
  const [V] = E.useState(C),
    G = l ?? V,
    q = typeof t == "string" ? [t, G] : G,
    _ = e6(a ?? []),
    K = E.useMemo(() => _c(_), [_]),
    { data: B, mutate: W } = Lu([q, "messages"], null, { fallbackData: K }),
    D = E.useRef(B || []);
  E.useEffect(() => {
    D.current = B || [];
  }, [B]);
  const { data: ne, mutate: te } = Lu([q, "streamData"], null),
    ae = E.useRef(ne);
  E.useEffect(() => {
    ae.current = ne;
  }, [ne]);
  const { data: ie = "ready", mutate: ue } = Lu([q, "status"], null),
    { data: N = void 0, mutate: J } = Lu([q, "error"], null),
    Q = E.useRef(null),
  ...
  const x = E.useCallback(
      async (Ae, Se = "generate") => {
        ...
        try {
          ...
          (await yv({
            ...
            onResponse: m,
            onUpdate({ message: I, data: ee, replaceLastMessage: de }) {
              (ue("streaming"),
                ft([...(de ? _e.slice(0, _e.length - 1) : _e), I], !1),
                ee?.length && el([...(mt ?? []), ...ee], !1));
            },
            onToolCall: c,
            onFinish: y,
            generateId: C,
      ...
      [W, ue, t, be, m, y, g, J, te, ae, p, o, s, c, h, D, Q, C, j, R, Y, G]
    ),
    F = E.useCallback(
      async (
        Ae,
    ...
    ge = E.useCallback(
      (Ae) => {
        typeof Ae == "function" && (Ae = Ae(D.current));
        const Se = _c(Ae);
        (W(Se, !1), (D.current = Se));
      },
      [W]
    ...
    se = E.useCallback(
      (Ae) => {
        (typeof Ae == "function" && (Ae = Ae(ae.current)),
          te(Ae, !1),
          (ae.current = Ae));
      },
      [te]
    ...
    xt = E.useCallback(
      ({ toolCallId: Ae, result: Se }) => {
        ...
        if (
          ...
          W([...ve.slice(0, ve.length - 1), { ...ve[ve.length - 1] }], !1),
    ...
    (q?.addEventListener("abort", () => {
      ...
      l.addEventListener(
        ...
        (ue) => {
          let N;
          try {
            N = JSON.parse(ue.data);
          } catch {
            return;
          }
          N.type === "cf_agent_use_chat_response" &&
            N.id === ne &&
            (ae.enqueue(new TextEncoder().encode(N.body)),
            N.done && (ae.close(), te.abort()));
        },
        { signal: te.signal }
      ));
    let ae;
  ...
  return (
    E.useEffect(() => {
      function v(C) {
        ...
        j.type === "cf_agent_chat_clear" && k.setMessages([]);
      }
      function A(C) {
        if (typeof C.data != "string") return;
        let j;
        ...
        j.type === "cf_agent_chat_messages" && k.setMessages(j.messages);
      }
      return (
...
const bt = (t) => {
  ...
  Z6 = () => {
    const t = bt("color"),
      ...
      B = () => [he, fe, p],
      W = () => [qr, "full", "auto", ...B()],
      D = () => [Al, "none", "subgrid", he, fe],
      ne = () => ["auto", { span: ["full", Al, he, fe] }, Al, he, fe],
      te = () => [Al, "auto", he, fe],
      ae = () => ["auto", "min", "max", "fr", he, fe],
      ie = () => [
        "start",
        "end",
        "center",
      ...
      Q = () => [t, he, fe],
      be = () => [...G(), R1, C1, { position: [he, fe] }],
      x = () => ["no-repeat", { repeat: ["", "x", "y", "space", "round"] }],
      F = () => ["auto", "cover", "contain", j6, N6, { size: [he, fe] }],
      le = () => [Hc, Pa, $l],
      w = () => ["", "none", "full", m, he, fe],
      oe = () => ["", ze, Pa, $l],
    ...
    return {
      ...
      classGroups: {
        aspect: [{ aspect: ["auto", "square", qr, fe, he, j] }],
        container: ["container"],
        ...
        z: [{ z: [Al, "auto", he, fe] }],
        basis: [{ basis: [qr, "full", "auto", h, ...B()] }],
        "flex-direction": [
          { flex: ["row", "row-reverse", "col", "col-reverse"] },
        ],
        "flex-wrap": [{ flex: ["nowrap", "wrap", "wrap-reverse"] }],
        flex: [{ flex: [ze, qr, "auto", "initial", "none", fe] }],
        grow: [{ grow: ["", ze, he, fe] }],
          ...
          ? (() => {
              ...
              if (G) {
                const q = G.getBoundingClientRect(),
                  { top: _, left: K, bottom: B, right: W } = q,
                  D = window.innerWidth,
...
var Ut = {
  ...
  Uu = { normal: qf, gfm: t8, pedantic: n8 },
...
`),
            ...
            let R = this.rules.other.nextBulletRegex(A),
              ...
              q = this.rules.other.htmlBeginRegex(A);
            for (; t; ) {
              let _ = t.split(
                  `
`,
              ...
              if (
                ...
                this.options.pedantic
                  ? ((k = k.replace(this.rules.other.listReplaceNesting, "  ")),
                    (K = k))
                  : (K = k.replace(this.rules.other.tabCharGlobal, "    ")),
                V.test(k) || G.test(k) || q.test(k) || R.test(k) || Y.test(k))
              )
                break;
              if (K.search(this.rules.other.nonSpaceChar) >= A || !k.trim())
                y +=
                  `
` + K.slice(A);
              else {
...
function B8(t, l) {
  ...
  if (a.length > 4 && a.slice(0, 4) === "data" && U8.test(l)) {
    if (l.charAt(4) === "-") {
      const c = l.slice(5).replace(V1, Z8);
...
const q8 = Ag([Tg, N8, Mg, zg, Dg], "html"),
...
`,
  ...
  Bc = function (C, j) {
    ...
    function V(ae) {
      var ie = ae.match(l);
      ie && (R += ie.length);
      var ue = ae.lastIndexOf(p);
      Y = ~ue ? ae.length - ue : Y + ae.length;
    }
    function G() {
      var ae = { line: R, column: Y };
      return function (ie) {
        return ((ie.position = new q(ae)), B(), ie);
      };
    }
    function q(ae) {
      ((this.start = ae),
    ...
    function _(ae) {
      var ie = new Error(j.source + ":" + R + ":" + Y + ": " + ae);
      if (
        ((ie.reason = ae),
        (ie.filename = j.source),
        (ie.line = R),
        (ie.column = Y),
        (ie.source = C),
        !j.silent)
    ...
    function W(ae) {
      var ie;
      for (ae = ae || []; (ie = D()); ) ie !== !1 && ae.push(ie);
      return ae;
    }
    function D() {
      var ae = G();
    ...
    function ne() {
      var ae = G(),
        ie = K(i);
      if (ie) {
        if ((D(), !K(o))) return _("property missing ':'");
        var ue = K(c),
          N = ae({
            type: v,
    ...
    function te() {
      var ae = [];
      W(ae);
      for (var ie; (ie = ne()); ) ie !== !1 && (ae.push(ie), W(ae));
      return ae;
    }
    return (B(), te());
  };
...
function T4(t) {
  ...
  function h(V) {
    if (i < a.length) {
      const G = a[i];
      return ((l.containerState = G[1]), t.attempt(G[0].continuation, p, m)(V));
    }
    return m(V);
  }
  function p(V) {
    if ((i++, l.containerState._closeFlow)) {
      ...
      R(i);
      let K = G;
      for (; K < l.events.length; ) ((l.events[K][1].end = { ..._ }), K++);
      return (
        nn(l.events, q + 1, 0, l.events.slice(G)),
        (l.events.length = K),
        m(V)
      );
    }
  ...
  function C(V) {
    if (V === null) {
      (j(t.exit("chunkFlow"), !0), R(0), t.consume(V));
      return;
    }
    return ye(V)
      ? (t.consume(V),
    ...
    if (
      ...
      for (; _--; )
        if (
          ...
          return;
      const K = l.events.length;
      let B = K,
        W,
        D;
      for (; B--; )
        if (l.events[B][0] === "exit" && l.events[B][1].type === "chunkFlow") {
          if (W) {
            D = l.events[B][1].end;
            break;
          }
      ...
      for (R(i), _ = K; _ < l.events.length; )
        ((l.events[_][1].end = { ...D }), _++);
      (nn(l.events, B + 1, 0, l.events.slice(K)), (l.events.length = _));
    }
  }
  function R(V) {
    let G = a.length;
    for (; G-- > V; ) {
      const q = a[G];
      ((l.containerState = q[1]), q[0].exit.call(l, t));
    }
    a.length = V;
  }
  function Y() {
...
function B4(t, l, a) {
  ...
  function m(_) {
    const K = i.events[i.events.length - 1];
    return (
      (c =
  ...
  function g(_) {
    return _ === null || ye(_)
      ? (t.exit("codeFencedFence"), i.interrupt ? l(_) : t.check(J1, C, G)(_))
  ...
  function q(_, K, B) {
    ...
    function te(ue) {
      return ue === h ? (_.enter("codeFencedFenceSequence"), ae(ue)) : B(ue);
    }
    function ae(ue) {
      return ue === h
        ? (W++, _.consume(ue), ae)
    ...
    function ie(ue) {
      return ue === null || ye(ue) ? (_.exit("codeFencedFence"), K(ue)) : B(ue);
    }
  }
}
function V4(t, l, a) {
...
const Zc = { name: "codeIndented", tokenize: q4 },
  Z4 = { partial: !0, tokenize: I4 };
function q4(t, l, a) {
  const i = this;
  return o;
  function o(m) {
...
function $4(t, l) {
  ...
  for (
    s.events = [],
      v ? ((v._tokenizer = void 0), (v.previous = void 0)) : j.pop(),
      k = j.length;
    k--;

  ) {
    const R = h.slice(j[k], j[k + 1]),
      Y = c.pop();
...
function mk(t, l, a) {
    ...
    return w === 33
      ...
      : w === 47
        ...
        : w === 63
          ...
          : jt(w)
            ? (t.consume(w), (s = String.fromCharCode(w)), j)
            : a(w);
  }
  function k(w) {
    return w === 45
  ...
  function C(w) {
    return jt(w) ? (t.consume(w), (s = String.fromCharCode(w)), j) : a(w);
  }
  function j(w) {
  ...
  function q(w) {
    return w === 61 ? (t.consume(w), _) : He(w) ? (t.consume(w), q) : V(w);
  }
  function _(w) {
        ...
        : w === 62 && o === 4
          ...
          : w === 63 && o === 3
            ...
            : w === 93 && o === 5
              ? (t.consume(w), be)
              : ye(w) && (o === 6 || o === 7)
                ? (t.exit("htmlFlowData"), t.check(hk, le, ae)(w))
                : w === null || ye(w)
                  ? (t.exit("htmlFlowData"), ae(w))
                  : (t.consume(w), te);
  }
  function ae(w) {
    return t.check(dk, ie, le)(w);
  }
  function ie(w) {
    return (t.enter("lineEnding"), t.consume(w), t.exit("lineEnding"), ue);
  }
  function ue(w) {
    return w === null || ye(w) ? ae(w) : (t.enter("htmlFlowData"), te(w));
  }
  function N(w) {
  ...
  function Q(w) {
    if (w === 62) {
      ...
      return em.includes(oe) ? (t.consume(w), F) : te(w);
    }
...
function xk(t, l, a) {
  ...
  function v(x) {
    return x === 62 ? N(x) : x === 45 ? k(x) : g(x);
  }
  function A(x) {
    const F = "CDATA[";
    return x === F.charCodeAt(c++)
      ? (t.consume(x), c === F.length ? C : A)
      : a(x);
  }
  function C(x) {
    return x === null
  ...
  function R(x) {
    return x === 62 ? N(x) : x === 93 ? (t.consume(x), R) : C(x);
  }
  function Y(x) {
    return x === null || x === 62
      ? N(x)
  ...
  function _(x) {
    return x === 45 || Ot(x) ? (t.consume(x), _) : K(x);
  }
  function K(x) {
    return ye(x) ? ((s = K), J(x)) : He(x) ? (t.consume(x), K) : N(x);
  }
  function B(x) {
    return x === 45 || Ot(x)
      ? (t.consume(x), B)
...
const qc = { name: "lineEnding", tokenize: Ok };
function Ok(t, l) {
  return a;
  function a(i) {
    return (
...
const tm = { name: "setextUnderline", resolveTo: qk, tokenize: Ik };
function qk(t, l) {
  let a = t.length,
    i,
    o,
...
function iS(t, l, a) {
  ...
  function g(ne) {
    return (
      ...
      s[s.length - 1] !== null
        ? []
        : (B(l, 0), (m.events = lo(c, m.events, m)), m.events)
    );
  }
  function k(ne, te) {
    return oS(v(ne), te);
  ...
  function A() {
    ...
    return { _bufferIndex: ne, _index: te, line: ae, column: ie, offset: ue };
  }
  function C(ne) {
    ((o[ne.line] = ne.column), D());
  }
  function j() {
    let ne;
  ...
  function Y(ne) {
    (ye(ne)
      ? (i.line++, (i.column = 1), (i.offset += ne === -3 ? 2 : 1), D())
  ...
  function K(ne, te) {
    ...
    function ae(ie, ue, N) {
      let J, Q, be, x;
      return Array.isArray(ie) ? le(ie) : "tokenize" in ie ? le([ie]) : F(ie);
      function F(se) {
        return Ee;
        function Ee(Te) {
      ...
      function le(se) {
        return ((J = se), (Q = 0), se.length === 0 ? N : w(se[Q]));
      }
      function w(se) {
        return Ee;
        function Ee(Te) {
      ...
      function ge(se) {
        return (x.restore(), ++Q < J.length ? w(J[Q]) : N);
      }
    }
  }
  function B(ne, te) {
  ...
  function W() {
    const ne = A(),
      te = m.previous,
      ae = m.currentConstruct,
      ie = m.events.length,
      ue = Array.from(h);
    return { from: ie, restore: N };
    function N() {
      ((i = ne),
        (m.previous = te),
        (m.currentConstruct = ae),
        (m.events.length = ie),
        (h = ue),
        D());
    }
...
function pS(t, l, a) {
  ...
  if (a.charCodeAt(0) === 35) {
    const o = a.charCodeAt(1),
      c = o === 120 || o === 88;
    return Zg(a.slice(c ? 2 : 1), c ? 16 : 10);
  }
  return Wf(a) || t;
}
...
function gS(t) {
  ...
  function o(I, ee, de) {
    ...
    return ((I[ee][1]._spread = Rt), de);
  }
  function c(I, ee) {
    return de;
    function de(me) {
      (h.call(this, I(me), me), ee && ee.call(this, me));
    }
  }
  function s() {
  ...
  function h(I, ee, de) {
    (this.stack[this.stack.length - 1].children.push(I),
      this.stack.push(I),
      this.tokenStack.push([ee, de || void 0]),
      (I.position = { start: _l(ee.start), end: void 0 }));
  }
  function p(I) {
    return ee;
    function ee(de) {
  ...
  function m(I, ee) {
    ...
    if (me)
      me[0].type !== I.type &&
        (ee ? ee.call(this, I, me[0]) : (me[1] || lm).call(this, I, me[0]));
    else
      throw new Error(
        "Cannot close `" +
          I.type +
  ...
  function k(I) {
    if (this.data.expectingFirstListItemValue) {
      ...
      ((ee.start = Number.parseInt(this.sliceSerialize(I), 10)),
  ...
  function K(I) {
    const ee = this.stack[this.stack.length - 1];
    ee.depth = this.sliceSerialize(I).codePointAt(0) === 61 ? 1 : 2;
  }
  function B() {
  ...
  function D(I) {
    ...
    ((ee.value += this.sliceSerialize(I)), (ee.position.end = _l(I.end)));
  }
  function ne(I) {
    const ee = this.stack[this.stack.length - 1];
    ...
    !this.data.setextHeadingSlurpLineEnding &&
      l.canContainEols.includes(ee.type) &&
      (W.call(this, I), D.call(this, I));
  }
  function te() {
  ...
  function Q(I) {
    const ee = this.sliceSerialize(I),
      de = this.stack[this.stack.length - 2];
    ((de.label = dS(ee)), (de.identifier = vn(ee).toLowerCase()));
  }
  function be() {
    const I = this.stack[this.stack.length - 1],
      ee = this.resume(),
  ...
  function se(I) {
    ...
    let me;
    de
      ? ((me = Zg(ee, de === "characterReferenceMarkerNumeric" ? 10 : 16)),
  ...
  function Ee(I) {
    const ee = this.stack.pop();
    ee.position.end = _l(I.end);
  }
  function Te(I) {
    D.call(this, I);
    const ee = this.stack[this.stack.length - 1];
    ee.url = this.sliceSerialize(I);
  }
  function lt(I) {
    D.call(this, I);
    const ee = this.stack[this.stack.length - 1];
    ee.url = "mailto:" + this.sliceSerialize(I);
  }
  function at() {
...
function qS(t, l) {
  const a = { type: "text", value: ZS(String(l.value)) };
  return (t.patch(l, a), t.applyData(l, a));
}
function IS(t, l) {
...
function KS(t) {
  ...
  for (; ++p < t.footnoteOrder.length; ) {
    ...
    if (j && j.type === "element" && j.tagName === "p") {
      const Y = j.children[j.children.length - 1];
      (Y && Y.type === "text"
        ? (Y.value += " ")
    ...
    function k() {
      ...
      if ("children" in p && p.children) {
        ...
        if (R.children && v[0] !== rw)
          for (
            C = (i ? R.children.length : -1) + s, j = y.concat(R);
            C > -1 && C < R.children.length;

          ) {
            const Y = R.children[C];
            if (((A = h(Y, C, j)()), A[0] === Af)) return A;
  ...
  return (
    (Ic = function p() {
      var m,
        ...
        Y = !1;
      for (
        typeof C == "boolean" && ((Y = C), (C = arguments[1] || {}), (j = 2)),
...
function Iw(t, l, a) {
  ...
  function p(m, y) {
    ...
    for (; V; ) {
      const G = V.index,
        q = { index: V.index, input: V.input, stack: [...y, m] };
      let _ = v(...V, q);
      if (
        (typeof _ == "string" &&
        ...
        _ === !1
          ? (k.lastIndex = G + 1)
          : (A !== G && Y.push({ type: "text", value: m.value.slice(A, G) }),
  ...
  for (; ++g < m; ) {
    ...
    C === 99
      ...
      : C === 108
        ...
        : C === 114 && (R = ":");
    let Y =
      a.alignDelimiters === !1 ? 1 : Math.max(1, p[g] - j.length - R.length);
    const V = j + "-".repeat(Y) + R;
    (a.alignDelimiters !== !1 &&
      ((Y = j.length + Y + R.length), Y > p[g] && (p[g] = Y), (v[g] = Y)),
      (k[g] = V));
  }
    ...
    for (; ++g < m; ) {
      ...
      if (a.alignDelimiters !== !1) {
        ...
        _ === 114
          ...
          : _ === 99
            ? q % 2
              ? ((V = " ".repeat(q / 2 + 0.5)), (G = " ".repeat(q / 2 - 0.5)))
              : ((V = " ".repeat(q / 2)), (G = V))
            : (G = " ".repeat(q));
      }
...
`)
  ...
  function p(v, A, C, j) {
    const R = C.enter("tableCell"),
      Y = C.enter("phrasing"),
      V = C.containerPhrasing(v, { ...j, before: c, after: c });
    return (Y(), R(), V);
  }
  function m(v, A) {
  ...
  function g(v, A, C) {
    ...
    const Y = [],
      V = A.enter("tableRow");
    for (; ++R < j.length; ) Y[R] = p(j[R], v, A, C);
    return (V(), Y);
  }
  function k(v, A, C) {
    let j = ky.inlineCode(v, A, C);
    return (C.stack.includes("tableCell") && (j = j.replace(/\|/g, "\\$&")), j);
  }
}
function fE() {
  return {
...
function jE(t) {
  ...
  function c(s, h, p) {
    ...
    function v(A) {
      ...
      if (g < 2 && !a) return p(A);
      const j = s.exit("strikethroughSequenceTemporary"),
        R = Xr(A);
      return (
        (j._open = !R || (R === 2 && !!C)),
        (j._close = !C || (C === 2 && !!R)),
...
function ZE() {
  return { flow: { null: { name: "table", tokenize: qE, resolveAll: IE } } };
}
function qE(t, l, a) {
  const i = this;
  let o = 0,
  ...
  function h(D) {
    ...
    const te = ne > -1 ? i.events[ne][1].type : null,
      ae = te === "tableHead" || te === "tableRow" ? _ : p;
    return ae === _ && i.parser.lazy[i.now().line] ? a(D) : ae(D);
  }
  function p(D) {
    return (t.enter("tableHead"), t.enter("tableRow"), m(D));
  }
  function m(D) {
    return (D === 124 || ((s = !0), (c += 1)), y(D));
  }
  function y(D) {
    return D === null
      ? a(D)
  ...
  function g(D) {
    return D === null || D === 124 || et(D)
      ? (t.exit("data"), y(D))
      : (t.consume(D), D === 92 ? k : g);
  }
  function k(D) {
    return D === 92 || D === 124 ? (t.consume(D), g) : g(D);
  }
  function v(D) {
    return (
      (i.interrupt = !1),
  ...
  function C(D) {
    return He(D) ? Ue(t, j, "whitespace")(D) : j(D);
  }
  function j(D) {
    return D === 58
      ? ((c += 1),
  ...
  function R(D) {
    return D === 45 ? (t.enter("tableDelimiterFiller"), Y(D)) : q(D);
  }
  function Y(D) {
    return D === 45
      ? (t.consume(D), Y)
      : D === 58
        ? ((s = !0),
          ...
          t.exit("tableDelimiterMarker"),
          V)
        : (t.exit("tableDelimiterFiller"), V(D));
  }
  function V(D) {
    return He(D) ? Ue(t, G, "whitespace")(D) : G(D);
  }
  function G(D) {
    return D === 124
      ? A(D)
      : D === null || ye(D)
        ? !s || o !== c
          ? q(D)
          : (t.exit("tableDelimiterRow"), t.exit("tableHead"), l(D))
        : q(D);
  }
  function q(D) {
    return a(D);
  ...
  function B(D) {
    return D === null || D === 124 || et(D)
      ? (t.exit("data"), K(D))
      : (t.consume(D), D === 92 ? W : B);
  }
  function W(D) {
    return D === 92 || D === 124 ? (t.consume(D), B) : B(D);
  }
}
function IE(t, l) {
  let a = -1,
    ...
    v[0] === "enter"
      ...
      : A.type === "tableHead"
        ...
        : A.type === "tableRow" || A.type === "tableDelimiterRow"
          ? ((p = a),
            c[1] !== 0
              ? ((s[0] = s[1]), (g = qu(k, l, c, o, a, g)))
              : s[1] !== 0 && (g = qu(k, l, s, o, a, g)),
            (o = 0))
          : o &&
            (A.type === "data" ||
              A.type === "tableDelimiterMarker" ||
...
function yA() {
  ...
  const Y = y.some((G) =>
      G.parts?.some(
        (q) =>
          q.type === "tool-invocation" &&
          q.toolInvocation.state === "call" &&
          Tm.includes(q.toolInvocation.toolName)
      )
    ),
    V = (G) => G.toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" });
  return Z.jsxs("div", {
    className:
      ...
      Z.jsxs("div", {
        ...
        children: [
                ...
                return Z.jsxs(
                  "div",
                  {
                    children: [
                      ...
                      Z.jsx("div", {
                        className: `flex ${_ ? "justify-end" : "justify-start"}`,
                        children: Z.jsxs("div", {
                          className: `flex gap-2 max-w-[85%] ${_ ? "flex-row-reverse" : "flex-row"}`,
                          children: [
                            K && !_
                              ? Z.jsx(I6, { username: "AI" })
                              : !_ && Z.jsx("div", { className: "w-8" }),
                            Z.jsx("div", {
                              children: Z.jsx("div", {
                                children: G.parts?.map((B, W) => {
                                  if (B.type === "text")
                                    return Z.jsxs(
                                      "div",
                                      {
                                        children: [
                                          Z.jsxs(Gu, {
                                            className: `p-3 rounded-md bg-neutral-100 dark:bg-neutral-900 ${_ ? "rounded-br-none" : "rounded-bl-none border-assistant-border"} ${B.text.startsWith("scheduled message") ? "border-accent/50" : ""} relative`,
                                            children: [
                                              B.text.startsWith(
                                                "scheduled message"
                                              ) &&
                                          ...
                                          Z.jsx("p", {
                                            className: `text-xs text-muted-foreground mt-1 ${_ ? "text-right" : "text-left"}`,
                                            children: V(new Date(G.createdAt)),
                                          }),
                                        ],
                                      },
                                      W
                                  ...
                                  if (B.type === "tool-invocation") {
                                    const D = B.toolInvocation,
                                      ne = D.toolCallId,
                                      te = Tm.includes(D.toolName);
                                    return a
                                      ? null
                                      : Z.jsx(
                                          gA,
          ...
          Z.jsx("form", {
            onSubmit: (G) => {
              (G.preventDefault(),
                v(G, { data: { annotations: { hello: "world" } } }),
                c("auto"));
            },
            className:
              ...
              children: Z.jsxs("div", {
                ...
                children: [
                  Z.jsx(dg, {
                    ...
                    onChange: (G) => {
                      (k(G),
                        (G.target.style.height = "auto"),
                        (G.target.style.height = `${G.target.scrollHeight}px`),
                        c(`${G.target.scrollHeight}px`));
                    },
                    onKeyDown: (G) => {
                      G.key === "Enter" &&
                        !G.shiftKey &&
                        !G.nativeEvent.isComposing &&
                        (G.preventDefault(), v(G), c("auto"));
                    },
                    rows: 2,
                    style: { height: o },
                  }),
